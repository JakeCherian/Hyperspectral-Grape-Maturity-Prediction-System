...
# Models:
#   Model 1 - StandardScaler → PCA → XGBoostRegressor
#   Model 2 - StandardScaler → PCA → CatBoostRegressor
# ================================================================
...
def create_factor_bar_charts(results_model1, results_model2):
    ...
    for key, ylabel in factor_specs:
        ...
        plt.bar(x - bar_width/2, df1[key].values, bar_width, label='XGBoost', color='#2a9d8f')
        plt.bar(x + bar_width/2, df2[key].values, bar_width, label='CatBoost', color='#e76f51')
...
def main():
    ...
    results_model1 = predict_and_analyze(X, models1, grape_ids, "Model 1 (XGBoost)")
    results_model2 = predict_and_analyze(X, models2, grape_ids, "Model 2 (CatBoost)")
